...
cur_dir=`pwd`
work_dir="/root/workspace/github/ark-server-docker/"
...
# 启动 ARK 服务端
bin/run_ark.sh -u "root" -p "EXP123456" -a "ADMIN654321" -h "3" -t "5" -r "0.5" -g "2" -x "10" -c "10" -s "EXP_ARK_Server" -m "Ragnarok" -i "1404697612,928102085,2885013943,751991809,731604991,889745138,902616446,1211297684,893904615,895711211,1232362083,618916953,722649005"
